"""Keyword-based routing — deterministic stub used by test StubLLM fixtures.

Extracted from the deprecated ``apps.api.core.hermes.router`` module.
"""
...
def keyword_route(message: str, available_agents: list[str]) -> _RoutingDecision:
    msg = message.lower()
