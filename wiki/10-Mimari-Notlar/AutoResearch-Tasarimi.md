...
Andrej Karpathy'nin bahsettiği "AutoResearch" (Otomatik Araştırma) otonom sistem tasarım prensipleri OneProduct-Agent-OS'e entegre edilmiştir. Bu tasarımın merkezinde, insanın optimizasyon döngüsünde darboğaz olmasını engelleyerek sistemin kendi kendine en iyi parametreleri araması yer alır.
...
- Dosya yolu: [program.md](file:///Users/gokhan/Desktop/OneProduct-Agent-OS/wiki/20-Projeler/program.md)
...
- [AutoResearchEngine](file:///Users/gokhan/Desktop/OneProduct-Agent-OS/backend/apps/api/core/autoresearch/engine.py) sınıfı döngü yöneticisidir.
...
- Döngü bitiminde en yüksek başarı sağlayan parametreler seçilir ve tüm süreci detaylandıran şık bir markdown raporu oluşturulur: [autoresearch_report.md](file:///Users/gokhan/Desktop/OneProduct-Agent-OS/wiki/20-Projeler/autoresearch_report.md)
