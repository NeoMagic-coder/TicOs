...
export function GrowthPage() {
  ...
  return (
    <div className="flex flex-col h-full bg-[#1a1816] text-gray-200 overflow-hidden">
      ...
      <ChatCommandBar
        commands={[
          { label: 'Tüm deneyleri başlat', message: 'tüm deneyleri hepsini başlat' },
          { label: 'Yeni deney öner', message: `${product?.product_name ?? 'ürünüm'} için 3 yeni deney hipotezi öner` },
          { label: 'En iyi büyüme kanalı', message: 'en etkili 3 büyüme kanalı hangisi, öncelik sırala' },
          { label: 'Upsell stratejisi', message: `${product?.product_name ?? 'ürünüm'} için upsell ve bundle stratejisi öner` },
        ]}
      />
